...
async function main() {
  ...
  const questionData = [
    {
      ...
      explanation: 'Turn signals should be used to indicate your intentions to other road users.',
      options: [
        { content: 'Only when turning', isCorrect: true },
        { content: 'When changing lanes', isCorrect: true },
        { content: 'When pulling over to the side of the road', isCorrect: true },
    ...
    options: [
      { content: 'Only when turning', isCorrect: true },
      { content: 'When changing lanes', isCorrect: true },
      { content: 'When pulling over to the left side of the road', isCorrect: true },
      { content: 'All of the above', isCorrect: true },
    ],
  },
  // Question 2
  {
    ...
    explanation: 'Respect posted speed limits in residential areas to ensure the safety of pedestrians and residents.',
    options: [
  ...
  // Question 3
  {
    ...
    explanation: 'Driving on the left side of the road is common in some regions.',
    options: [
  ...
  // Question 4
  {
    ...
    explanation: 'Drivers already in the roundabout have the right of way over entering traffic.',
    options: [
  ...
  // Question 5
  {
    content: 'What is the minimum safe following distance in ideal driving conditions?',
    explanation: 'Maintaining a safe following distance helps prevent collisions.',
    options: [
  ...
  // Question 6
  {
    ...
    explanation: 'Yellow lights warn that the signal is about to change to red. Prepare to stop if safe to do so.',
    options: [
  ...
  // Question 7
  {
    content: 'What does a triangular road sign with an exclamation mark mean?',
    explanation: 'This sign warns of potential hazards or unexpected conditions ahead.',
    options: [
  ...
  // Question 8
  {
    ...
    explanation: 'Overtaking is generally allowed when the road ahead is clear and it is safe to do so.',
    options: [
  ...
  // Question 9
  {
    ...
    explanation: 'Continue to the next exit and re-route. Do not reverse on a highway.',
    options: [
  ...
  // Question 10
  {
    content: 'What is the legal blood alcohol concentration (BAC) limit for drivers?',
    explanation: 'Driving under the influence of alcohol is dangerous and against the law.',
    options: [
  ...
  // Question 11
  {
    ...
    explanation: 'Follow posted speed limits on highways to ensure safety and compliance with regulations.',
    options: [
  ...
  // Question 12
  {
    ...
    explanation: 'Come to a complete stop at a stop sign. Proceed only when it is safe to do so.',
    options: [
      { content: 'Yield', isCorrect: false },
  ...
  // Question 13
  {
    content: 'What should you do when approaching a school bus with flashing red lights?',
    explanation: 'Stop until the red lights stop flashing to ensure the safety of children boarding or exiting the bus.',
    options: [
      { content: 'Proceed with caution', isCorrect: false },
      { content: 'Pass the bus if children are not yet crossing', isCorrect: false },
  ...
  // Question 14
  {
    ...
    explanation: 'Use your horn to alert others to your presence or warn of potential danger.',
    options: [
  ...
  // Question 15
  {
    content: 'How much space should you leave between your vehicle and a bicyclist when passing?',
    explanation: 'Leave at least 1 meter of space when passing a bicyclist to ensure their safety.',
    options: [
  ...
  // Question 16
  {
    ...
    explanation: 'Extend your left arm upward to indicate a right turn when hand signals are required.',
    options: [
  ...
  // Question 17
  {
    content: 'What should you do if your vehicle starts to skid on a slippery road?',
    explanation: 'Steer in the opposite direction of the skid to regain control of your vehicle.',
    options: [
      { content: 'Slam on the brakes', isCorrect: false },
      { content: 'Steer in the opposite direction of the skid', isCorrect: true },
  ...
  // Question 18
  {
    content: 'What does a yellow diamond-shaped sign with two opposite-facing arrows mean?',
    explanation: 'This sign warns of two-way traffic ahead. Stay in your lane and be cautious.',
    options: [
  ...
  // Question 19
  {
    content: 'In your area, what does a blue circular sign with a white arrow indicate?',
    ...
    options: [
      ...
      { content: 'Mandatory direction of travel indicated by the arrow', isCorrect: true },
      { content: 'Hospital ahead', isCorrect: false },
    ],
  },
  // Question 20
  {
    content: 'When is it appropriate to use high beams while driving at night?',
    explanation: 'Use high beams when driving in rural or unlit areas, but dim them when approaching other vehicles.',
    options: [
  ...
  // Question 21
  {
    ...
    explanation: 'A green light indicates that you can proceed if the way is clear and safe.',
    options: [
      { content: 'Stop', isCorrect: false },
      { content: 'Proceed with caution', isCorrect: false },
  ...
  // Question 22
  {
    content: 'What does a white rectangular sign with black lettering "SCHOOL ZONE" mean?',
    explanation: 'This sign warns of an upcoming school zone. Be prepared to slow down and watch for children.',
    options: [
      { content: 'No entry', isCorrect: false },
  ...
  // Question 23
  {
    ...
    explanation: 'A yellow flashing light indicates caution. Slow down and proceed with care.',
    options: [
      { content: 'Ignore and proceed', isCorrect: false },
      { content: 'Stop immediately', isCorrect: false },
      { content: 'Proceed with caution', isCorrect: true },
      { content: 'Turn around and find an alternate route', isCorrect: false },
    ],
  },
  // Question 24
  {
    content: 'What does a red equilateral triangle sign indicate?',
    explanation: 'This sign warns of an upcoming yield. Be prepared to slow down and yield the right of way if necessary.',
    options: [
      { content: 'Stop', isCorrect: false },
  ...
  // Question 25
  {
    content: 'What should you do when approaching a railroad crossing with flashing lights and bells?',
    explanation: 'Stop before the railroad crossing when lights are flashing, and bells are ringing. Wait for the train to pass.',
    options: [
